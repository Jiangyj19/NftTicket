...
//add
//blue:"0088E2"
const colors = {white: "#ffffff", black: "#000000", teal: "#0088E2", grey: "#7a7a7a", light_grey: "#b5b5b5", 
  dark_grey: "#363636", orange: "#e85623",blue:"0088E2"};
...
class App extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      // let web3 = new Web3(new Web3.providers.HttpProvider("https://ropsten.infura.io/v3/84e02827a94446f38cb4b655cc275363"));
      let web3Provider;
      if (window.ethereum) {
      ...
      // If no injected web3 instance is detected, fall back to Ganache
        ...
        web3Provider = new Web3.providers.HttpProvider("https://ropsten.infura.io/v3/84e02827a94446f38cb4b655cc275363");
      }
  ...
  render() {
    ...
    return (
      ...
      <div className="App">
        ...
        <div className="address" style={{backgroundColor:colors.teal}}><span className="text-mono margin-left-sm">
        {this.state.accounts?'Address: '+this.state.accounts:'Wallet Not Connected'}</span></div>
          ...
          >
            {/* <Tab label={this.state.accounts}{...tabProps(4)}/> */}
